...
<div class="items form large-9 medium-8 columns content">
    ...
    <fieldset>
        ...
        <?php
            ...
            echo $this->Form->control('sell_unit_qty',array('type'=>'number','default'=>$item->sell_unit_qty,'min'=>'1', 'max'=>'9999999999'));
            echo $this->Form->control('sell_unit',array('type'=>'select','options'=>$units));
            echo $this->Form->control('usage_unit_qty',array('type'=>'number','min'=>'1', 'max'=>'9999999999'));
